...
class RRChangePrice extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'change:rr-price';
    ...
    public function handle()
    {
        ...
        foreach ($data->items as $item) {
            ...
            if($item['rr_Detail_Item_Id'] == $item_id){
                $total = $new_price * $item['rr_Detail_Item_Qty_Received'];
                ...
                DeliveryItems::where('rr_Detail_Item_Id', $item_id)->update([
                    'rr_Detail_Item_ListCost' => $new_price,
