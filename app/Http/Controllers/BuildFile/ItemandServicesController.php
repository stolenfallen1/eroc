...
class ItemandServicesController extends \TCG\Voyager\Http\Controllers\Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $view = 'buildfile.itemmaster.browse';
    ...
    public function show(Request $request, $id)
    {
        ...
        $view = 'buildfile.itemmaster.read';
    ...
    public function edit(Request $request, $id)
    {
        ...
        $view = 'buildfile.itemmaster.edit-add';
    ...
    public function order(Request $request)
    {
        ...
        if (empty($dataType->order_column) || empty($dataType->order_display_column)) {
            ...
            ->with([
                'message'    => __('buildfile.itemmaster.ordering_not_set'),
                'alert-type' => 'error',
            ]);
        }
        ...
        $view = 'buildfile.itemmaster.order';
