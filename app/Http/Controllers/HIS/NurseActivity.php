        ...
        if($accountType !== 'Self Pay') {
            $dataCharges = $cashAssessmentQuery
                ...
                ->unique(function ($item) {
                    return $item->patient_Id . $item->case_No . $item->revenue_Id . $item->referenceNum . $item->item_Id;
                })->toArray();

            $dataCharges = array_values($dataCharges);
