    ...
    public function register(Request $request) {
        ...
        try {
            ...
            $patientRegistryRule = [
                ...
                $request->validate([
                    'patient_id' => ['required', new UniquePatientRegistration($request->input('patient_id'))],
                ])
            ];
            ...
            $patientPastMedicalProcedureData = [
                'patient_Id'                    => $patient_id,
                'description'                   => '',
                'date_Of_Procedure'             => $request->payload['date_Of_Procedure'],
                'createdby'                     => Auth()->user()->idnumber,
                'updatedby'                     => Auth()->user()->idnumber,
                'created_at'                    => now(),
                'updated_at'                    => now()
            ...
            $patientVitalSignsData = [
                ...
                'bloodPressureSystolic'     => $request->payload['bloodPressureSystolic'],
                'bloodPressureDiastolic'    => $request->payload['bloodPressureDiastolic'],
                'temperature'               => $request->payload['temperatue'],
                'pulseRate'                 => $request->payload['pulseRate'],
                'respiratoryRate'           => $request->payload['respiratoryRate'],
                'oxygenSaturation'          => $request->payload['oxygenSaturation'],
                'createdby'                 => Auth()->user()->idnumber,
                'updatedby'                 => Auth()->user()->idnumber,
                'created_at'                => now(),
                'updated_at'                => now()
            ...
            $patientRegistry = PatientRegistry::updateOrCreate($patientRegistryRule, $patientRegistryData);
            ...
            if(!$patient || !$patientRegistry) {
                ...
                PatientPastImmunizations::create($patientPastImmunizationData);
                PatientPastMedicalHistory::create($patientPastMedicalHistoryData);
                PatientPastMedicalProcedures::create($patientPastMedicalProcedureData);
            }
