    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $delivery = Delivery::create([
                ...
                'rr_Document_Invoice_No' => $request['invoice_number'],
                'rr_Document_Invoice_Date' => Carbon::parse($request['invoice_date']),
            ...
            foreach ($request['details'] as $key => $detail) {
                ...
                foreach ($detail['batches'] as $key1 => $batch) {
                    ...
                    ItemBatch::create([
                        ...
                        'item_Expiry_Date' => $batch['item_Expiry_Date'] ? Carbon::parse($batch['item_Expiry_Date']) : NULL,
                        'isConsumed' => 0,
