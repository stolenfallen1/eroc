        ...
        try {
            ...
            $delivery = Delivery::updateOrCreate(
                ...
                [
                    ...
                    'rr_Document_Terms_Id'                  => $request['vendor']['term'] ? $request['vendor']['term']['id'] : '',
            ...
            foreach ($request['details'] as $key => $detail) {
                ...
                $delivery_item = DeliveryItems::create(
                    [
                        ...
                        'rr_Detail_Item_Qty_BackOrder'                  => $detail['rr_Detail_Item_Qty_BackOrder'] == 0 ? 0 : $detail['rr_Detail_Item_Qty_BackOrder'],
