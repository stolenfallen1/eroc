    ...
    public function update(Request $request, $id)
    {
        ...
        try{
            ...
            if($type == 'posting'){
                ...
                $cashonhand['postedby'] = Auth()->user()->id;
                ...
                $cashonhand['updatedBy'] =Auth()->user()->id;
            }
            ...
            if($type == 'posting') {
                ...
                $to = Carbon::now()->format('Y-m-d H:i');
                ...
                Payments::where('createdBy', Auth()->user()->id)->whereBetween('payment_date',[$from,$to])->update([
                    'isposted' => '1',
