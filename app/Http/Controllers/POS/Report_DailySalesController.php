...
class Report_DailySalesController extends Controller
{
    /**
    ...
    public function DailysalesReport(Request $request)
    {
        if($request->payload) {
            ...
            $datatable = DB::connection('sqlsrv_pos')->select('EXEC spDailySalesReport ?, ?, ?, ?', [$terminalid, $cashierid, $shift, $date]);
            $data['data'] = [];
            ...
            return $this->print_out_layout($data,$papersize,'DailySalesReport');
