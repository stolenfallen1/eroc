...
<html>
    ...
    <body>
        ...
        <section style="text-align: center; margin-top: 20px;">
            ...
            <span style="font-weight: 500; font-style: italic; font-size: 16px;">{{ $pdf_data['sub_title'] . '( Outpatient )' }}</span>
        </section>
            ...
            {{-- @for ($i = 0; $i < 500; $i++)  --}}
                @foreach($pdf_data['transactions'] as $data)
                    <table>
                        <thead>
                            <tr>
                                <th style="background-color: #f2f2f2; font-weight: bold; width: 50%;">Patient Name</th>
                    ...
                    <table>
                        <thead>
                            <tr>
                                <th style="font-style: italic; font-size: 14px; font-weight: 500; width: 50%;">Item Description</th>
