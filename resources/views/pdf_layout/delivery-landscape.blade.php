...
<body>
  ...
  <table>
    <tr>
      ...
      <td colspan="2" width="10" class="item-td border-none border-bottom text-left">{{$pdf_data['currency']}}{{number_format($pdf_data['sub_total'], 4)}}</td>
    </tr>

    <tr>
      <td colspan="10" width="150" class="border-none  text-right">Less : Discount :</td>
      <td colspan="2" width="10" class="item-td border-none border-bottom text-left">{{$pdf_data['currency']}}{{number_format($pdf_data['discount'], 4)}}</td>
    </tr>
    <tr>
      <td colspan="10" width="150" class="border-none  text-right"></td>
      <td colspan="2" width="10" class="item-td border-none border-bottom text-left">{{$pdf_data['currency']}}{{number_format(($pdf_data['sub_total'] - $pdf_data['discount']), 4)}}</td>
    </tr>
    <tr>
      <td colspan="10" width="150" class="border-none  text-right"></td>
    ...
    <tr>
      ...
      <td colspan="2" width="10" class="item-td border-none border-bottom text-left">
        ...
        {{number_format(($pdf_data['vatableSales']), 4)}}
    ...
    <tr>
      ...
      <td colspan="2" width="10" class="item-td border-none border-bottom text-left">{{$pdf_data['currency']}}{{number_format($pdf_data['vat_amount'], 4)}}</td>
    </tr>
    <!-- <tr>
      <td class="border-none text-right"></td>
      <td class="border-none  text-left "> </td>
      <td colspan="8" class="border-none text-right">SubTotal (Vat Exclusive):</td>
      <td colspan="2" class="item-td border-none border-bottom text-left">{{$pdf_data['currency']}}{{number_format($pdf_data['sub_total'], 4)}}</td>
    </tr> -->
    <tr>
