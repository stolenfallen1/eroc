...
<body>
  ...
  <table class="signatory-section1">
    <tbody>
      ...
      <tr>
        <td class="underline item-td">{{$pdf_data['purchase_order']['administrator']['name']}}</td>
      </tr>
      <tr>
      ...
      <tr>
        <td class=" comptroller underline item-td">{{$pdf_data['purchase_order']['comptroller']['name']}}</td>
      </tr>
      @endif
      <tr>
      ...
      <tr>
        <td class=" comptroller underline item-td">{{$pdf_data['purchase_order']['corporateAdmin']['name']}}</td>
      </tr>
      <tr>
      ...
      <tr>
        <td class=" comptroller underline item-td">{{$pdf_data['purchase_order']['president']['name']}}</td>
      </tr>
      <tr>
  ...
  <table class="signatory-section2">
    <tbody>
      ...
      <tr>
        <td style="padding-top:10px; text-transform: uppercase;" class="item-td underline">{{$pdf_data['canvaser']}}</td>
      </tr>
      <tr>
        <td>
