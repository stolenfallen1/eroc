    ...
    <div class="content-section">
        <table class="denominationtable">
            ...
            <tbody>
                ...
                <tr>
                    <td  class="text-right" colspan="2">SENIOR/PWD SALES</td>
                    <td></td>
                </tr>
                <tr>
                    <td  class="text-right" colspan="2">TOTAL VATABLE SALES</td>
                    <td></td>
                </tr>
                <tr>
                    <td  class="text-right" colspan="2">TOTAL SALES</td>
                    <td></td>
                </tr> --}}
            </tbody>
        </table>
