...
<head>
    ...
    <style>
        ...
        th, td {
            padding: 4px; /* Padding for th and td */
...
<body>
    ...
    <table>
        ...
        <tbody>
            ...
            @foreach($pdf_data['groupedLocation'] as $location)
            <!-- <tr>
                <td class="font-md text-center" colspan="6">
                    {{ $location['locationName'] }}
                </td>
            </tr> -->
            @foreach($location['categories'] as $categoryKey => $category)
            <tr>
                <td class="font-md" colspan="6"><br></td>
            </tr>
            <tr>
                <td style="border-bottom: 1px dotted #000;" class="font-md" colspan="6">{{ $category['CategoryName'] ?? 'N/A' }}</td>
            </tr>
            <tr>
                <td class="font-md" colspan="6"><br></td>
            </tr>
                ...
                <tr>
                    <td class="font-md itemid text-center" style="padding:15px;">
                        {{ $item->id }}
                    </td>
